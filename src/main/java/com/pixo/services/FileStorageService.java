...
import com.pixo.exceptions.FileStorageException;
import com.pixo.exceptions.MyFileNotFoundException;
import com.pixo.models.FileItemEntity;
import com.pixo.models.User;
import com.pixo.property.FileStorageProperties;
import com.pixo.repositories.FileItemRepository;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            FileItemEntity fie = new FileItemEntity(user, fileName, targetLocation.toString(), false);

            System.out.println("Saving FileSystem Entity");
            repository.save(fie);
